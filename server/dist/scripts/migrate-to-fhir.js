...
exports.migratePatients = migratePatients;
exports.migrateObservations = migrateObservations;
exports.migrateFacilities = migrateFacilities;
        ...
        for (const patient of patients) {
            try {
                ...
                if (Object.keys(updates).length > 0) {
                    await Patient_1.default.findByIdAndUpdate(patient._id, updates);
                    migratedCount++;
                }
            }
            catch (error) {
...
async function migrateObservations() {
    ...
    try {
        const observations = await Observation_1.default.find({});
        let migratedCount = 0;
        let errorCount = 0;
        for (const observation of observations) {
            try {
                ...
                // Update if there are changes
                if (Object.keys(updates).length > 0) {
                    await Observation_1.default.findByIdAndUpdate(observation._id, updates);
                    migratedCount++;
                }
            }
            catch (error) {
...
async function migrateFacilities() {
    ...
    try {
        const facilities = await Facility_1.default.find({});
        let migratedCount = 0;
        let errorCount = 0;
        for (const facility of facilities) {
            try {
                ...
                // Update if there are changes
                if (Object.keys(updates).length > 0) {
                    await Facility_1.default.findByIdAndUpdate(facility._id, updates);
                    migratedCount++;
                }
            }
            catch (error) {
